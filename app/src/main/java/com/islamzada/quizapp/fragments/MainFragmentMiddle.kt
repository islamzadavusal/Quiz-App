...
import com.islamzada.quizapp.databinding.FragmentMainMiddleBinding
import com.islamzada.quizapp.model.QuestionModel
import com.islamzada.quizapp.repo.QuestionRepositoryMiddle
import java.util.Locale
import java.util.concurrent.TimeUnit

class MainFragmentMiddle : Fragment() {

    private lateinit var binding: FragmentMainMiddleBinding

    lateinit var questionsList: ArrayList<QuestionModel>
    private var index: Int = 0
    lateinit var questionModel: QuestionModel

    private val questionRepositoryMiddle = QuestionRepositoryMiddle()
    ...
    override fun onCreateView(
        ...
        binding = FragmentMainMiddleBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        questionsList = questionRepositoryMiddle.getQuestions()
    ...
    fun countdown() {
        val duration: Long = TimeUnit.SECONDS.toMillis(13)
